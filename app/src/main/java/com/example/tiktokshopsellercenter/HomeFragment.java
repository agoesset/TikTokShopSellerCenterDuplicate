...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView promosi = view.findViewById(R.id.promosi);
        TextView tambah2 = view.findViewById(R.id.textView12);
        Button tambah = view.findViewById(R.id.button);

        promosi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), PromosiActivity.class);
